...
export const otherFarmABI = [
  {
    type: "constructor",
    stateMutability: "nonpayable",
    inputs: [
      { type: "address", name: "_finn", internalType: "contract FINN" },
      { type: "address", name: "_devaddr", internalType: "address" },
      { type: "uint256", name: "_finnPerSecond", internalType: "uint256" },
      { type: "uint256", name: "_startTime", internalType: "uint256" },
      { type: "uint256", name: "_allEndTime", internalType: "uint256" },
    ],
  },
  {
    type: "event",
  ...
  },
  {
    type: "function",
    stateMutability: "view",
    outputs: [{ type: "address", name: "", internalType: "contract FINN" }],
    name: "finn",
    inputs: [],
  },
  {
...
export const otherChefAbi = (rewardPerBlockName: string): AbiItem[] => {
  const cakeAbi = otherFarmABI as AbiItem[];
  cakeAbi.push({
    inputs: [],
    name: rewardPerBlockName,
